...
int RL_EN_right = 11; // băm xung phải
int R_PWM_right = 13;// điều khiển chiều quay phải
int L_PWM_right = 12;// điều khiển chiều quay phải

int RL_EN_left = 3; // băm xung trái
int R_PWM_left = 4;// điều khiển chiều quay trái
int L_PWM_left = 2;// điều khiển chiều quay trái
